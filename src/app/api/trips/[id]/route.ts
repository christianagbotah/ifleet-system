  ...
  try {
    ...
    const updatedTrip = await db.trip.update({
      ...
      data: {
        ...
        ...(loadingCityId !== undefined && { loadingCityId: loadingCityId || null }),
        ...(loadingPointId !== undefined && { loadingPointId: loadingPointId || null }),
        ...(destinationCityId !== undefined && { destinationCityId: destinationCityId || null }),
        ...(destinationZoneId !== undefined && { destinationZoneId: destinationZoneId || null }),
