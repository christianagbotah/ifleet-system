#!/bin/bash
# iFleetPro — AI Service Keepalive
# Restarts the AI service if it dies.
# Usage: nohup bash keepalive.sh </dev/null >/dev/null 2>&1 &

SERVICE_DIR="/home/z/my-project/mini-services/ai-service"
LOG_FILE="/home/z/my-project/ai-service.log"
...
while true; do
  ...
  echo "[$(date '+%Y-%m-%d %H:%M:%S')] AI service exited with code: $EXIT_CODE. Restarting in ${restart_delay}s..."
